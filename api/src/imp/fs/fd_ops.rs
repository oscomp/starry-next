...
use starry_core::{
    ctypes::{
        AT_FDCWD, F_DUPFD, F_DUPFD_CLOEXEC, F_SETFL, O_APPEND, O_CREAT, O_DIRECTORY, O_EXEC,
        O_NONBLOCK, O_RDONLY, O_TRUNC, O_WRONLY, mode_t,
    },
...
fn flags_to_options(flags: c_int, _mode: mode_t) -> OpenOptions {
...
#[apply(syscall_instrument)]
pub fn sys_open(path: UserConstPtr<c_char>, flags: i32, mode: mode_t) -> LinuxResult<isize> {
