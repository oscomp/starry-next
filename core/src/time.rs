...
use crate::ctypes::{timespec, timeval};
...
impl From<timeval> for TimeValue {
    fn from(tv: timeval) -> Self {
        TimeValue::new(tv.tv_sec as u64, tv.tv_usec as u32 * 1000)
    }
}

impl From<TimeValue> for timespec {
    fn from(d: TimeValue) -> Self {
        timespec {
...
impl From<TimeValue> for timeval {
    fn from(d: TimeValue) -> Self {
        timeval {
            tv_sec: d.as_secs() as _,
